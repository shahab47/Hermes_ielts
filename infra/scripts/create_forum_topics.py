...
TOPICS = [
    ...
    {
        "name": "Coding 💻",
        "intro": "💻 **Coding & Software Engineering Workspace**\n\nاین تاپیک فضای اختصاصی برنامه‌نویسی، حل باگ، بررسی کدهای پایتون، لینوکس و معماری است (بدون دخالت موضوعات آیلتس).\n\n💡 دستور نمونه: `این کد پایتون رو تحلیل و دیباگ کن`",
    },
]
