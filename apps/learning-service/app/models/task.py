...
class Task(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    answer_json: Mapped[Optional[dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    rubric_json: Mapped[Optional[dict[str, Any]]] = mapped_column(JSONB, nullable=True)
...
class PracticeSession(Base, UUIDPrimaryKeyMixin):
    ...
    objectives_json: Mapped[Optional[dict[str, Any]]] = mapped_column(JSONB, nullable=True)
